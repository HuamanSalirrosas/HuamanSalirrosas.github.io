...
- `styles.css` adapta la imagen al alto visible en pantallas de PC y móvil,
  ...
  recortarla ni añadir desplazamiento innecesario. La portada incorpora una
  franja clara en su primer octavo y difumina los cuatro bordes del retrato.

Para verlo, abre `index.html` en un navegador y usa los enlaces situados junto a
la imagen.
